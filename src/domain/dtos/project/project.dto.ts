export class ProjectDto {
  ...
  static body(object: { [key: string]: any }): [string?, ProjectDto?] {
    ...
    const { title, categoryId, typeProjectId, staffId, seasonId,students } = object;
    ...
    return [undefined, new ProjectDto(title, categoryId, typeProjectId, staffId, seasonId,students)];
  }
}